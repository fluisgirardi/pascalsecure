PascalSECURE is a securitysystem for the most popular standard controls of Lazarus
...
1) Insert a Security Manager. Choose one model (user level, user and authorizations, user/groups with authorizations...) 
   that best fits on your needs, or write your own model using a customizable model.
